...
import emulator.functionptrs.BasicALUFunction;
import emulator.functionptrs.MultiplicationDivisionFunction;
import emulator.functionptrs.OneOpenardBasicFunction;
import emulator.functionptrs.ShiftRotateFunction;

/**
 * 
 * bütün iþlemleri gerçekleþtiren, mantýksal ve aritmetik iþlemleri yapan, iþlemci'yi temsil eden sýnýf.
 *
 */
public class Processor {
	...
	/**
	 * gerekli initilization burada yapýlýr.
	 * @param memorySize
	 */
	...
	/**
	 * DS ve CS deðerleri burada verilir, bir nevi OS çalýþtýrýlýyormuþ gibi davranýr.
	...
	/**
	 * verilen addressToken'in adres deðeri hesaplanýr.
	 * @param addressToken
	...
	/**
	 * Sýradaki instruction çalýþtýrýlýr.
	 * 
	...
	/**
	 * instruction'un parametre sayýsýnýn uygun olup olmadýðý kontrol edilir.
	 * @param count
	 * @throws AssemblerException
	 */
	...
	/**
	 * 
	 * @param binary halde gelen deðer decimal hale döndürülür
	 * @return edilir.
	 */ 
	...
	/**
	 * decimal halde gelen sayý binary hale döndürür ve return eder.
	 * @param decimal 
	 * @param width
	 * @return
	 */
	...
	/**
	 * Overflow flag deðeri gelen inputlara göre deðerlendirilerek set edilir.
	 * @param left
	 * @param right
	 * @param w
	 */
	 ...
	 * @param gelen geniþlik deðerine göre hesaplanýr ve
	 * @return edilir.
	 */
	...
	/**
	 * @return flag register'i 16 bitlik bir sayý olarak return edilir ( int tipinde)
	 */
	...
	/**
	 * register'lara ilk deðer olan 0 deðeri yazýlýr.
	 */
	...
	/**
	 * @param result deðiþkenine göre flag deðerleri set edilir.
	 * @param width
	 */
	...
	/**
	 * Baþlangýçta test etmek için yazýlmýþ bir method.
	 * @throws EMURunTimeException
	 * @throws AssemblerException
	 */
	...
	/**
	 * Ýþlemci bütün her þeyi ilk baþtaki haline döndürür.
	 * @throws AssemblerException
	 */
