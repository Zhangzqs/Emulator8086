 ...
 * 
 * 
 * Text dosyasýný okuyan, anlamlandýran ve iþlemci sýnýfýna bazý fonksiyonlar ile yardým eden Assembler sýnýfý.
 *
 */
public class Assembler {
	...
	/**
	 * constructor
	 * @param file assembly kodu dosyasý
	...
	/**
	 * Stringlerden oluþan bir ArrayList'teki Stringlerin her birindeki whiteSpace karakterlerini yok eder.
	 * @param tokens
	...
	/**
	 * eðer input bir adres ise true döner.
	 * adres formatlarý: [AX], [CS:AX], [AX] + immediate, variable
	 * @param token
	 * @return
	 */
	...
	/**
	 * eðer input bir register ismi ise true döner
	 * @param token
	 * @return
	 */
	...
	/**
	 * eðer input bir immediate deðer ise doðru döner. thirtyTwoBitsMode false ise sayý en fazla 16 bit olarak hesaplanýr.
	 * @param string
	...
	/**
	 * input sayýnýn immediate deðeri döndürülür.
	 * @param token
	 * @return
	 * @throws AssemblerException
	 */
	...
	/**
	 * eðer satýrýn baþýnda label var ise bu label silinir ve satýr return edilir.
	 * @param index
	 * @return
	 */
	...
	/**
	 * Verilen isimdeki register'ýn RegisterType türündeki deðeri return edilir.
	 * @param register
	 * @return
	 * @throws AssemblerException
	 */
	...
	/**
	 * Satýrdaki kelimeler ayrý ayrý Stringlere çevrilerek yeni bir liste olarak döndürülür.
	 * @param line
	 * @return
	 */
	...
	/**
	 * Assembly dosyasý okunur.
	 * Okunurken Label ve variable tablolarý da oluþturulur.
	 * Instruction içeren satýrlar ayrý bir String array'ine konulur.
	 * @throws AssemblerException
	 */
	...
	/**
	 * Eðer satýrda variable var ise bu variable listesine eklenir.
	 * @param line
	 * @return Eðer satýrda bir variable varsa o true döner.
	 * @throws AssemblerException
	 */
	 ...
	 * 
	 * @param token
	 * @param thirtyTwoBitMode eðer false ise sayý en fazla 16 bir olarak hesaplanýr.
	 * @return input String'i bir sayý ise bunun immediate hali dönülür.
	 * @throws AssemblerException 
	 */
	...
	/**
	 * 
	 * @param number en fazla 32 bir data içeren long deðeri
	 * @return long deðerindeki her bir bit bire bir int içine kopyalanýr.
	 */
	 ...
	 * @return 'a' formatýndaki string'in içindeki karakter'in deðeri return edilir.
	 */
	...
	/**
	 * @param string
	 * @return string in karakter decleration olup olmadýðý kontrol edilir. ( 'a' formatý)
	 */
	...
	/**
	 * TODO array desteði verilemedi.. bu fonksiyonu tamamla
	 * array halindeki variable'larýn AssemblyVariable objelerini yaratýr.
	 * @param tokensArray
	 * @throws AssemblerException
	 */
	...
	/**
	 * @param varName
	 * @return eðer variable olma þartlarýna uyuyor ise doðru return edilir
	 */
	 ...
	 * 
	 * @param token
	 * @return eðer token label olma özelliði taþýyorsa doðru return edilir.
	 */
	...
	/**
	 * Assembly dosyasý deðiþtiði zaman çaðrulmalýdýr, dosyayý en baþtan okuyup anlamlandýrýr.
	 * @throws AssemblerException
	 */
	...
	/**
	 * variable'larý memory deki gerekli yerlere koyar
	 * @param memory
	 * @param beginningAddress
	 * @param incrementing memory addresiinin hangi yöne doðru ilerleriðini belirler.
	 */
